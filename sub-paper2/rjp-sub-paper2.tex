...
As a first step, the results concerning the excited spectrum of the four TSD bands will be presented. 
...
\label{appendix:a}
The two models described in Section 2, namely the formalism $\texttt{W1}$ and \texttt{W2} are schematically represented. The \texttt{W1} mode corresponds to the work given in Refs. \cite{raduta2020approach,raduta2020towards}, and the \texttt{W2} corresponds to the formalism developed in this two-part series of papers. For the formalism \texttt{W1}, the diagram is shown in Figure \ref{w1-model-worfklow}, while for the newly developed approach \texttt{W2}, the diagram is shown in Figure \ref{w2-model-worfklow}. Coupling scheme for the second formalism is also represented in Figure \ref{three-couplings}.
