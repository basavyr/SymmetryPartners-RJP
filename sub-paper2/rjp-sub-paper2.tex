...
As already mentioned in the previous section, for the numerical part of this research, the adoption of the parameters obtained from the fitting procedure made in \textbf{I} will be adopted for consistency of the \texttt{W2} approach. Their values are represented in Table \ref{parameter_set}. It is worth noting that for the case of \texttt{W1}, the geometrical interpretation of the classical energy function would have required two such sets of parameters, and therefore, two sets of calculations.
