...
For a better understanding of the wobbling regimes in terms of angular momentum alignment, the schematic illustration from Figure depicts a simple wobbler (the case firstly developed by Bohr and Mottelson \cite{bohr1998nuclear}), a longitudinal wobbler, and lastly a transverse wobbler.
