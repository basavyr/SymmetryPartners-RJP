...
\begin{figure}
    ...
    \includegraphics[scale=0.6]{figs/tsd1_spin1.eps}
    % \includegraphics[width=0.8\textwidth]{figs/tsd2_spin1.eps}
    \includegraphics[scale=0.6]{figs/tsd2_spin1.eps}
...
\begin{figure}
    ...
    \includegraphics[scale=0.6]{figs/tsd3_spin1.eps}
    % \includegraphics[width=0.8\textwidth]{figs/tsd4_spin1.eps}
    \includegraphics[scale=0.6]{figs/tsd4_spin1.eps}
