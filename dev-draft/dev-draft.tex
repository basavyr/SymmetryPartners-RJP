...
\begin{enumerate}[(a)]
    ...
    \item Coupling $C'_2$: the odd $j_1$ proton aligns with the core with an odd-integer spin sequence $R_1=1,3,5,\dots$, which has negative parity $\pi_2=-1$.
\end{enumerate}

Based on Obviously, the odd valence nucleon $j_1$ has a positive parity $\pi_{j_1}=+1$. 
